...
const OurWork = () => {
  ...
  const machines = [
    {
      ...
      description:
        "Using cutting-edge flex printing technology and expert techniques, we deliver vibrant, high-definition prints with precision and speed.",
    ...
    },
    {
      ...
      description:
        "Our eco-solvent printing combines advanced machinery with sustainable practices for durable, eye-catching graphics produced professionally.",
    ...
    },
    {
      ...
      description:
        "With the latest digital printing systems and skilled operation, we ensure crisp, consistent color and flawless print quality for every project.",
    ...
    },
    {
      ...
      description:
        "We leverage innovative, eco-friendly fabric printing technology and meticulous workmanship to create sharp, environmentally responsible textile prints.",
  ...
  return (
    <section
      ref={ref}
      className="bg-white pt-8 pb-16 sm:pb-24 px-4 sm:px-8 lg:px-8 font-sans relative"
    >
      <div className="container mx-auto max-w-7xl">
        {/* --- HEADER SECTION --- */}
        <div
          className={`text-center mb-12 lg:mb-24 transition-all duration-700 ${
